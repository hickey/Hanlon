    ...
    class Node < ProjectHanlon::Slice
      ...
      def get_node_help
        return ["Node Slice: used to view the current list of nodes (or node details)".red,
                ...
                "\thanlon node [get] [all] --policy,-o POLICY_UUID                " + "Display nodes bound by policy instance".yellow,
                "\thanlon node [get] [all] --attribs,-a ATTRIBS_LIST              " + "Display additional attributes in output".yellow,
